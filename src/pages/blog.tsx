...
function Blog() {
  ...
  return (
    <>
      <Head>
        <title>Blog - Matthew Downs</title>
        <meta name="description" content="Explore the latest blog posts by Matthew Downs. Stay up-to-date on industry trends and best practices with insights from a seasoned software developer." />
        <meta name="keywords" content="matthewdowns,matthew downs,blog,blogs,blogging,blog posts,posts" />
      </Head>
